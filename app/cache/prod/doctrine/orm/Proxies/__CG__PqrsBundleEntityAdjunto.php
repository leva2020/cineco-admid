 ...
 */
class Adjunto extends \PqrsBundle\Entity\Adjunto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'url', 'tipo', '' . "\0" . 'PqrsBundle\\Entity\\Adjunto' . "\0" . 'respuesta', '' . "\0" . 'PqrsBundle\\Entity\\Adjunto' . "\0" . 'pqrs');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Adjunto $proxy) {
