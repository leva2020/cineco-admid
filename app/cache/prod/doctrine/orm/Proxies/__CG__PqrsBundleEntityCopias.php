 ...
 */
class Copias extends \PqrsBundle\Entity\Copias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'correo', '' . "\0" . 'PqrsBundle\\Entity\\Copias' . "\0" . 'respuesta');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Copias $proxy) {
