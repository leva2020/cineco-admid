 ...
 */
class Permisos extends \PqrsBundle\Entity\Permisos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', '' . "\0" . 'PqrsBundle\\Entity\\Permisos' . "\0" . 'roles');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Permisos $proxy) {
