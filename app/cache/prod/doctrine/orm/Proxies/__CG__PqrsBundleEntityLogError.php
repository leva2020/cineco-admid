 ...
 */
class LogError extends \PqrsBundle\Entity\LogError implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fecha', 'adjunto', 'pqrs', 'respuesta');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LogError $proxy) {
