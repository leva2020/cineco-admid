 ...
 */
class Roles extends \PqrsBundle\Entity\Roles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'permisos', 'usuario');
        }
    ...
    public function addPermiso(\PqrsBundle\Entity\Permisos $permisos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPermiso', array($permisos));

        return parent::addPermiso($permisos);
    }
    ...
    public function removePermiso(\PqrsBundle\Entity\Permisos $permisos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePermiso', array($permisos));

        return parent::removePermiso($permisos);
    }
