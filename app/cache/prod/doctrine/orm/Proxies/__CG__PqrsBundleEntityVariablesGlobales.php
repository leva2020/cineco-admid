 ...
 */
class VariablesGlobales extends \PqrsBundle\Entity\VariablesGlobales implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'valor');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VariablesGlobales $proxy) {
